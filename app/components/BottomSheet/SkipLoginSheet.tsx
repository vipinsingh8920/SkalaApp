        ...
        <View style={[GlobalStyleSheet.container, { backgroundColor:theme.dark ? COLORS.title:COLORS.white, }]}>
            ...
            <View style={{}}>
                ...
                <View style={{paddingTop:10}}>
                    <Text style={[FONTS.fontRegular,{fontSize:14,color:colors.title}]}>By continuing, you agree to Skala's <Text style={[FONTS.fontSemiBold,{color:COLORS.primary}]}>Terms of Use</Text>{"\n"}and <Text style={[FONTS.fontSemiBold,{color:COLORS.primary}]}>Privacy Policy</Text>.</Text>
                </View>
            </View>
